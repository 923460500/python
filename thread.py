...
class mainFrame(wx.Frame):
    def __init__(self):
        ...
        wx.StaticText(self, -1, u'第二行输入框', pos=(10, 50), size=(100, -1), style=wx.ALIGN_LEFT)
        ...
        self.tc2 = wx.TextCtrl(self, -1, u'', pos=(100, 50), size=(150, -1), name='TC02',
                               style=wx.TE_PASSWORD | wx.ALIGN_RIGHT)

        btn_mea = wx.Button(self, -1, u'鼠标左键时间', pos=(300, 50), size=(100, 25))
        btn_rig = wx.Button(self, -1, u'鼠标右键事件', pos=(400, 50), size=(100, 25))
        ...
        btn_rig.Bind(wx.EVT_MOUSE_EVENTS, self.OnMouse)
    ...
    def OnClose(self,evt):
        dlg = wx.MessageDialog(None, u'确认关闭本窗口？', wx.YES_NO | wx.ICON_QUESTION)
